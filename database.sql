...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2023 at 07:21 PM
...
(10000008, 'AF1', 'Desc', '2023-03-20', '15:35:36', NULL, NULL, 1, 310);
...
--
-- Dumping data for table `tbl_product_inv`
--
...
(10000008, 'Iloilo Hares', 'Desc', 10000, '2023-03-20', '15:36:17', 1, 1),
(10000009, 'Talisay', 'Desc_B', 20000, '2023-03-20', '15:40:42', 1, 1);
...
(10000006, 'Josephine', 'Desc', 1000, '2023-03-20', '15:37:20', 0, 1);
...
(310, 'Top Grade', '2023-03-20', '12:54:33', NULL, NULL, 1),
(311, '4 For 999', '2023-03-20', '15:35:20', NULL, NULL, 1);
...
(10000006, '', '', 'default@email.com', 'default', NULL, NULL, NULL, NULL, 0, '', ''),
(10000007, 'Morante', 'Mark', 's@email.com', 's', '2023-03-20', '15:34:26', NULL, NULL, 1, '', 'Manager'),
(10000008, 'Man', 'Demo', 'demoman@email.com', 'dm', '2023-06-04', '21:46:30', NULL, NULL, 1, '', 'Manager'),
(10000009, 'Feroni', 'Stef', 'stef@email.com', 'stef', '2023-06-04', '22:25:38', NULL, NULL, 1, '', 'Staff'),
(10000010, 'Z', 'A', 'first@email.com', 'f', '2023-06-04', '22:26:47', NULL, NULL, 1, '', 'Manager'),
(10000011, 'Adasdas', 'Asdadasd', 'asdasd@email', 'asdasd', '2023-06-04', '22:38:06', NULL, NULL, 1, '', 'Staff');
...
--
ALTER TABLE `tbl_receive`
  MODIFY `rec_id` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000010;

--
-- AUTO_INCREMENT for table `tbl_release`
--
ALTER TABLE `tbl_release`
  MODIFY `rel_id` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000007;

--
-- AUTO_INCREMENT for table `tbl_type`
--
ALTER TABLE `tbl_type`
  MODIFY `type_id` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
